--Perfil--
INSERT INTO  PERFIL (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES ( 1,'Adiministrador','Perfil de Adiministrador do sistema',CURRENT_TIMESTAMP);
INSERT INTO  PERFIL (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES ( 2,'Aluno','Perfil de aluno',CURRENT_TIMESTAMP);
INSERT INTO  PERFIL (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES ( 3,'Ledor','Perfil de ledor',CURRENT_TIMESTAMP);
INSERT INTO  PERFIL (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES ( 4,'Professor','Perfil de professor',CURRENT_TIMESTAMP);

--IDIOMA--
INSERT INTO IDIOMA (ID, NOME, DATA_INSERCAO) VALUES (1,'Português',CURRENT_TIMESTAMP);
INSERT INTO IDIOMA (ID, NOME, DATA_INSERCAO) VALUES (2,'Inglês',CURRENT_TIMESTAMP);
INSERT INTO IDIOMA (ID, NOME, DATA_INSERCAO) VALUES (3,'Espanhol',CURRENT_TIMESTAMP);
INSERT INTO IDIOMA (ID, NOME, DATA_INSERCAO) VALUES (4,'Frances',CURRENT_TIMESTAMP);
...
INSERT INTO ENDERECO (ID, BAIRRO, CEP, COMPLEMENTO, ID_CIDADE, DATA_INSERCAO) VALUES (2,'bairro02', 22222222,'complemento02',882, CURRENT_TIMESTAMP);
INSERT INTO ENDERECO (ID, BAIRRO, CEP, COMPLEMENTO, ID_CIDADE, DATA_INSERCAO) VALUES (3,'bairro03', 33333333,'complemento03',882, CURRENT_TIMESTAMP);
INSERT INTO ENDERECO (ID, BAIRRO, CEP, COMPLEMENTO, ID_CIDADE, DATA_INSERCAO) VALUES (4,'bairro04', 44444444,'complemento04',882, CURRENT_TIMESTAMP);

--TELEFONE--
INSERT INTO TELEFONE (ID, NUMERO, TIPO, DATA_INSERCAO) VALUES (1,11111111111111,'R',CURRENT_TIMESTAMP);
...
INSERT INTO IMAGEM (ID, DESCRICAO, URL, DATA_INSERCAO) VALUES (2, 'Um circulo de pessoa de diferente etinias se conectando atravez de uma linha pontilhada, no centro um sibolo de coneção. O desenho é estilo desenho animado','resources/imagem/noticia02.jpg',CURRENT_TIMESTAMP);

--COMPETENCIA--
INSERT INTO COMPETENCIA (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES (1,'Planejamento e gerência contábil de instituições.','Ciências Contábeis',CURRENT_TIMESTAMP);
INSERT INTO COMPETENCIA (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES (2,'É a ciência que cuida da aplicação das normas jurídicas vigentes em um país.','Direito',CURRENT_TIMESTAMP);
INSERT INTO COMPETENCIA (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES (3,'Conjunto de todas as atividades e soluções providas por recursos de computação que visam a produção, o armazenamento, a transmissão, o acesso, a segurança e o uso das informações.','Tecnologia da informação',CURRENT_TIMESTAMP);
INSERT INTO COMPETENCIA (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES (4,'Trata da educação dos jovens, que estuda os problemas relacionados com o seu desenvolvimento como um todo.','Pedagogia',CURRENT_TIMESTAMP);

--ASSUNTO--
INSERT INTO ASSUNTO (ID, DESCRICAO, NOME, DATA_INSERCAO) VALUES (1,'Relacionado a realização de provas de concurso publico.','Concurso público',CURRENT_TIMESTAMP);
...
--EDITORA--
INSERT INTO EDITORA (ID, NOME, DATA_INSERCAO) VALUES (1,'Editora 01',CURRENT_TIMESTAMP);
...
--AUTOR--
INSERT INTO AUTOR (ID, DATA_NASCIMENTO, NOME, DATA_INSERCAO) VALUES (1,'1111-11-11','Autor 01',CURRENT_TIMESTAMP);
...
--LIVRO--
INSERT INTO LIVRO (ID, SINOPSE, TITULO, ID_EDITORA, ID_IDIOMA, DATA_INSERCAO) VALUES (1,'Sinopse 01','titulo 01',1,1,CURRENT_TIMESTAMP);
INSERT INTO LIVRO (ID, SINOPSE, TITULO, ID_EDITORA, ID_IDIOMA, DATA_INSERCAO) VALUES (2,'Sinopse 02','titulo 02',2,2,CURRENT_TIMESTAMP);
...
--USUARIO--
INSERT INTO USUARIO (ID, EMAIL, LOGIN, SENHA, ID_PERFIL, ID_PESSOA, DATA_INSERCAO) VALUES (1,'EMAIL 01','LOGIN 01','SENHA 01',1,1,CURRENT_TIMESTAMP);
INSERT INTO USUARIO (ID, EMAIL, LOGIN, SENHA, ID_PERFIL, ID_PESSOA, DATA_INSERCAO) VALUES (2,'EMAIL 02','LOGIN 02','SENHA 02',2,2,CURRENT_TIMESTAMP);
INSERT INTO USUARIO (ID, EMAIL, LOGIN, SENHA, ID_PERFIL, ID_PESSOA, DATA_INSERCAO) VALUES (3,'EMAIL 03','LOGIN 03','SENHA 03',3,3,CURRENT_TIMESTAMP);
INSERT INTO USUARIO (ID, EMAIL, LOGIN, SENHA, ID_PERFIL, ID_PESSOA, DATA_INSERCAO) VALUES (4,'EMAIL 04','LOGIN 04','SENHA 04',4,4,CURRENT_TIMESTAMP);
...
INSERT INTO NOTICIA VALUES (1,'<p class="lead">Designer cria fonte que une braile ao alfabeto tradicional.</p>
				...
				<p>Fonte:https://exame.abril.com.br/estilo-de-vida/designer-cria-fonte-que-une-braile-ao-alfabeto-tradicional/</p>','1111-11-11','Notícia 01',1,1);
INSERT INTO NOTICIA VALUES (2,'<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
					...
					vel itaque amet.</p>','1111-11-11','Notícia 02',2,2);

--AULA--
INSERT INTO AULA (ID, DATA_HORARIO_AULA, DESCRICAO, NOME, ID_ASSUNTO, DATA_INSERCAO) VALUES (1,'1111-11-11','DESCRIÇÃO 01','AULA 01',1,CURRENT_TIMESTAMP);
INSERT INTO AULA (ID, DATA_HORARIO_AULA, DESCRICAO, NOME, ID_ASSUNTO, DATA_INSERCAO) VALUES (2,'1111-11-11','DESCRIÇÃO 02','AULA 02',2,CURRENT_TIMESTAMP);
INSERT INTO AULA (ID, DATA_HORARIO_AULA, DESCRICAO, NOME, ID_ASSUNTO, DATA_INSERCAO) VALUES (3,'1111-11-11','DESCRIÇÃO 03','AULA 03',3,CURRENT_TIMESTAMP);
INSERT INTO AULA (ID, DATA_HORARIO_AULA, DESCRICAO, NOME, ID_ASSUNTO, DATA_INSERCAO) VALUES (4,'1111-11-11','DESCRIÇÃO 04','AULA 04',4,CURRENT_TIMESTAMP);
...
--AUDIO_LIVRO--
INSERT INTO AUDIO_LIVRO (ID, TITULO, URL_AUDIO, ID_LEDOR, ID_LIVRO_REFERENCIA, DATA_INSERCAO) VALUES (1,'AUDIO LIVRO 01','',1,1,CURRENT_TIMESTAMP);
INSERT INTO AUDIO_LIVRO (ID, TITULO, URL_AUDIO, ID_LEDOR, ID_LIVRO_REFERENCIA, DATA_INSERCAO) VALUES (2,'AUDIO LIVRO 02','',2,2,CURRENT_TIMESTAMP);
INSERT INTO AUDIO_LIVRO (ID, TITULO, URL_AUDIO, ID_LEDOR, ID_LIVRO_REFERENCIA, DATA_INSERCAO) VALUES (3,'AUDIO LIVRO 03','',3,3,CURRENT_TIMESTAMP);
INSERT INTO AUDIO_LIVRO (ID, TITULO, URL_AUDIO, ID_LEDOR, ID_LIVRO_REFERENCIA, DATA_INSERCAO) VALUES (4,'AUDIO LIVRO 04','',4,4,CURRENT_TIMESTAMP);
