...
public class CadastroController {
	...
	@ResponseBody
	@GetMapping(path = "/getAutomovel/{id}")
	public AutomovelView getAutomovel(@PathVariable("id") Integer id) {
		return automovelService.getAutomovel(id);
	}
	...
	@ResponseBody
	@GetMapping(path = "/salvarAutomovel")
	public Integer adicionarAutomovel(AutomovelView automovelView) {
		return automovelService.salvarAutomovel(automovelView);
	}

	@ResponseBody
	@GetMapping(path = "/salvarFabricante")
	public Integer adicionarFabricante(FabricanteFiltroJson fabricanteFiltroJson) {
		return fabricanteService.salvarFabricante(fabricanteFiltroJson);
	}
