...
CREATE TABLE AUDIO_LIVRO(
  ...
  ID_LEDOR BIGINT,
  TITULO VARCHAR(50) NOT NULL,
  DESECRICAO VARCHAR(255) NOT NULL,
...
CREATE TABLE ACESSO_AUDIO_LIVRO(
  ...
  CONSTRAINT PK_ACESSO_AU PRIMARY KEY(ID),
...
CREATE TABLE AUDIO_LIVRO_ASSUNTO(
  ID_AUDIO_LIVRO BIGINT NOT NULL,
  ID_ASSUNTO BIGINT NOT NULL,
  CONSTRAINT PK_AUDIO_LIVRO_ASSUNTO PRIMARY KEY(ID_AUDIO_LIVRO,ID_ASSUNTO),
  CONSTRAINT FK_AUDIO_ASSUNTO_AUDIO FOREIGN KEY(ID_AUDIO_LIVRO) REFERENCES AUDIO_LIVRO(ID),
  CONSTRAINT FK_AUDIO_ASSUNTO_ASSUNTO FOREIGN KEY(ID_ASSUNTO) REFERENCES ASSUNTO(ID)
);
