insert into PERFIL (ID_CONTROLE_ALTERACAO, NOME, DESCRICAO) VALUES (1,'teste','teste');
insert into IDIOMA (ID, NOME) values (IDIOMA_SEQ.nextval,'Português'),(IDIOMA_SEQ.nextval,'Inglês'),(IDIOMA_SEQ.nextval,'Espanhol'),(IDIOMA_SEQ.nextval,'Frances');
