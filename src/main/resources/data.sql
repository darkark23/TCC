...
--ENDERECO--
INSERT INTO ENDERECO VALUES (1,'bairro01', 11111111,'complemento01',882);
INSERT INTO ENDERECO VALUES (2,'bairro02', 22222222,'complemento02',882);
INSERT INTO ENDERECO VALUES (3,'bairro03', 33333333,'complemento03',882);
INSERT INTO ENDERECO VALUES (4,'bairro04', 44444444,'complemento04',882);

--TELEFONE--
INSERT INTO TELEFONE VALUES (1,11111111111111,'R');
INSERT INTO TELEFONE VALUES (2,22222222222222,'C');
INSERT INTO TELEFONE VALUES (3,33333333333333,'T');
INSERT INTO TELEFONE VALUES (4,44444444444444,'C');

--FUNCIONALIDADE--
INSERT INTO FUNCIONALIDADE VALUES (1,'Funcionalidade de acesso aos horários de aula.','Agenda Aulas');
INSERT INTO FUNCIONALIDADE VALUES (2,'Funcionalidade de busca aos audio livros.','Buscar Audio Livros');
INSERT INTO FUNCIONALIDADE VALUES (3,'Funcionalidade de edição e submição de audio livros.','Submeter Audio Livro');
INSERT INTO FUNCIONALIDADE VALUES (4,'Funcionalidade de edição e submição de notícias.','Submeter Notícias');

--IMAGEM--
INSERT INTO IMAGEM VALUES (1, 'Livros sobre uma mesa de madeira com um quadro negro ao fundo.','resources/imagem/noticia01.jpg');
INSERT INTO IMAGEM VALUES (2, 'Um circulo de pessoa de diferente etinias se conectando atravez de uma linha pontilhada, no centro um sibolo de coneção. O desenho é estilo desenho animado','resources/imagem/noticia02.jpg');

--COMPETENCIA--
INSERT INTO COMPETENCIA VALUES (1,'Planejamento e gerência contábil de instituições.','Ciências Contábeis');
INSERT INTO COMPETENCIA VALUES (2,'É a ciência que cuida da aplicação das normas jurídicas vigentes em um país.','Direito');
INSERT INTO COMPETENCIA VALUES (3,'Conjunto de todas as atividades e soluções providas por recursos de computação que visam a produção, o armazenamento, a transmissão, o acesso, a segurança e o uso das informações.','Tecnologia da informação');
INSERT INTO COMPETENCIA VALUES (4,'Trata da educação dos jovens, que estuda os problemas relacionados com o seu desenvolvimento como um todo.','Pedagogia');

--ASSUNTO--
INSERT INTO COMPETENCIA VALUES (1,'Relacionado a realização de provas de concurso publico.','Concurso público');
INSERT INTO COMPETENCIA VALUES (2,'Relacionado com a área de de Graduação em nivel superior.','Nível Superior');
INSERT INTO COMPETENCIA VALUES (3,'Relacionado aos assuntos mais relevante da atualidade.','Atualidades');
INSERT INTO COMPETENCIA VALUES (4,'Relacionado ao controle e planejamento financeiro pessoal.','Educação Financeira');

--EDITORA--
INSERT INTO EDITORA VALUES (1,'Editora 01');
INSERT INTO EDITORA VALUES (2,'Editora 02');
INSERT INTO EDITORA VALUES (3,'Editora 03');
INSERT INTO EDITORA VALUES (4,'Editora 04');

--AUTOR--
INSERT INTO AUTOR VALUES (1,'11/11/1111','Autor 01');
INSERT INTO AUTOR VALUES (2,'11/11/1111','Autor 02');
INSERT INTO AUTOR VALUES (3,'11/11/1111','Autor 03');
INSERT INTO AUTOR VALUES (4,'11/11/1111','Autor 04');

--LIVRO--
INSERT INTO LIVRO VALUES (1,'Sinopse 01','titulo 01',1,1);
INSERT INTO LIVRO VALUES (2,'Sinopse 02','titulo 02',2,2);
INSERT INTO LIVRO VALUES (3,'Sinopse 03','titulo 03',3,3);
INSERT INTO LIVRO VALUES (4,'Sinopse 04','titulo 04',4,4);
...
--PESSOA--
INSERT INTO PESSOA VALUES (1,1111111111,'11/11/1111','PESSOA 01',1111111111,'M',1,NULL,1);
INSERT INTO PESSOA VALUES (2,2222222222,'11/11/1111','PESSOA 02',2222222222,'F',2,NULL,2);
INSERT INTO PESSOA VALUES (3,3333333333,'11/11/1111','PESSOA 03',3333333333,'M',3,NULL,3);
INSERT INTO PESSOA VALUES (4,4444444444,'11/11/1111','PESSOA 04',4444444444,'F',4,NULL,4);

--PESSOA_COMPETENCIA--
INSERT INTO PESSOA_COMPETENCIA VALUES (1,1);
INSERT INTO PESSOA_COMPETENCIA VALUES (2,2);
INSERT INTO PESSOA_COMPETENCIA VALUES (3,3);
INSERT INTO PESSOA_COMPETENCIA VALUES (4,4);

--USUARIO--
INSERT INTO USUARIO VALUES (1,'EMAIL 01','LOGIN 01','SENHA 01',1,1);
INSERT INTO USUARIO VALUES (2,'EMAIL 02','LOGIN 02','SENHA 02',2,2);
INSERT INTO USUARIO VALUES (3,'EMAIL 03','LOGIN 03','SENHA 03',3,3);
INSERT INTO USUARIO VALUES (4,'EMAIL 04','LOGIN 04','SENHA 04',4,4);

--ACESSO LOG--
INSERT  INTO ACESSO_LOG VALUES (1,'11/11/1111','Alterção de cadastro',1,1);
INSERT  INTO ACESSO_LOG VALUES (2,'11/11/1111','Alterção de cadastro',2,2);
INSERT  INTO ACESSO_LOG VALUES (3,'11/11/1111','Alterção de cadastro',3,3);
INSERT  INTO ACESSO_LOG VALUES (4,'11/11/1111','Alterção de cadastro',4,4);

--NOTICIA--
INSERT INTO NOTICIA VALUES (1,'<p class="lead">Designer cria fonte que une braile ao alfabeto tradicional.</p>
				<p>São Paulo – Um designer japonês teve uma ideia brilhante para tentar incluir ainda mais os deficientes visuais no dia-a-dia da sociedade: criar uma fonte tipográfica que une a escrita tradicional ao braile. A lógica por trás disso é permitir que cegos e outras pessoas possam compartilhar de uma mesma comunicação em um espaço comum.</p>
				<p>Como? Da seguinte maneira: os pontos do braile aprecem em alto relevo e integrados aos caracteres tradicionais do alfabeto latino. O designer Kosuke Takahashi, criador da fonte Braile Neue, propõe que essa tipografia seja adotada já nos próximos Jogos Olímpicos, que ocorrem daqui a dois anos, em Tóquio, capital do Japão.</p>
				<p>Mas há um problema: geralmente a comunicação em braile tende a ser pequena e quase invisível. Por isso, Takahashi diz que realizou uma pesquisa para ver se uma larga sinalização com a linguagem para deficientes visuais poderia ser legível a eles. “Descobri que é possível, contanto que exista um padrão de até seis pontos, independentemente do tamanho”, diz o designer, em seu website.</p>
				<p>“Hoje em dia, raramente vemos o braile implementado nos lugares públicos, uma vez que essa comunicação necessita de um espaço adicional, sendo considerada por aqueles que têm visão como algo não importante”, diz Takahashi.</p>
				<p>“A Braille Neue aborda essa questão, ao tornar o braile mais acessível para ser usado por pessoas sem deficiência visual. Ao divulgar essa fonte tipográfica, acredito que mais pessoas vão ficar familiarizadas com a linguagem”, acrescenta o designer.</p>
				<p>Ele afirma ainda que a fonte pode substituir as atuais sinalizações no espaço público, precisando apenas fazer alguns ajustes. “É fácil implementá-la na infraestrutura existente e é também um trampolim para um futuro mais sustentável e inclusivo após 2020”, comenta Takahashi.</p>
				<p>Fonte:https://exame.abril.com.br/estilo-de-vida/designer-cria-fonte-que-une-braile-ao-alfabeto-tradicional/</p>','11/11/1111','Notícia 01',1,1);
INSERT INTO NOTICIA VALUES (2,'<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
					...
					vel itaque amet.</p>','11/11/1111','Notícia 02',2,2);

--AULA--
INSERT INTO AULA VALUES (1,'11/11/1111','DESCRIÇÃO 01','AULA 01',1);
INSERT INTO AULA VALUES (2,'11/11/1111','DESCRIÇÃO 02','AULA 02',2);
INSERT INTO AULA VALUES (3,'11/11/1111','DESCRIÇÃO 03','AULA 03',3);
INSERT INTO AULA VALUES (4,'11/11/1111','DESCRIÇÃO 04','AULA 04',4);

--AULA_LEDOR--
INSERT  INTO AULA_LEDOR VALUES (1,1);
INSERT  INTO AULA_LEDOR VALUES (2,1);
INSERT  INTO AULA_LEDOR VALUES (3,2);
INSERT  INTO AULA_LEDOR VALUES (4,2);

--AUDIO_LIVRO--
INSERT INTO AUDIO_LIVRO VALUES (1,'AUDIO LIVRO 01','',1,1);
INSERT INTO AUDIO_LIVRO VALUES (2,'AUDIO LIVRO 02','',2,2);
INSERT INTO AUDIO_LIVRO VALUES (3,'AUDIO LIVRO 03','',3,3);
INSERT INTO AUDIO_LIVRO VALUES (4,'AUDIO LIVRO 04','',4,4);

--ACESSO_AUDIO_LIVRO--
INSERT INTO ACESSO_AUDIO_LIVRO VALUES (1,'11/11/1111,000000,1,1');
INSERT INTO ACESSO_AUDIO_LIVRO VALUES (2,'11/11/1111,000200,2,2');
INSERT INTO ACESSO_AUDIO_LIVRO VALUES (3,'11/11/1111,000300,3,3');
INSERT INTO ACESSO_AUDIO_LIVRO VALUES (4,'11/11/1111,000400,4,4');
