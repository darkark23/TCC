DROP TABLE IF EXISTS CONTROLE_ALTERACAO;
DROP SEQUENCE IF EXISTS CONTROLE_ALTERACAO_SEQ;
...
CREATE SEQUENCE CONTROLE_ALTERACAO_SEQ START WITH 1 INCREMENT BY 1;
...
CREATE TABLE CONTROLE_ALTERACAO(
                                   ID BIGINT NOT NULL DEFAULT CONTROLE_ALTERACAO_SEQ.NEXTVAL,
                                   DATA_INSERCAO DATE NOT NULL,
                                   ID_USUARIO_INSERCAO BIGINT,
                                   DATA_EXCLUSAO DATE,
                                   ID_USUARIO_EXCLUSAO BIGINT,
                                   CONSTRAINT PK_CONT_ALT PRIMARY KEY(ID)
    --CONSTRAINT FK_CONT_ALT_USUARIO_INS FOREIGN KEY(ID_USUARIO_INSERCAO) REFERENCES USUARIO(ID),
    --CONSTRAINT FK_CONT_ALT_USUARIO_EXC FOREIGN KEY(ID_USUARIO_EXCLUSAO) REFERENCES USUARIO(ID)
);

INSERT INTO  CONTROLE_ALTERACAO (DATA_INSERCAO, ID_USUARIO_INSERCAO, DATA_EXCLUSAO, ID_USUARIO_EXCLUSAO) VALUES (CURRENT_DATE,NULL,NULL,NULL);
...
CREATE TABLE COMPETENCIA(
                            ...
                            ID_CONTROLE_ALTERACAO BIGINT NOT NULL,
                            NOME VARCHAR(50),
                            DESCRICAO VARCHAR(50),
                            CONSTRAINT PK_COMPETENCIA PRIMARY KEY(ID),
                            CONSTRAINT FK_COMPETENCIA_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE PESSOA_COMPETENCIA(
                                   ...
                                   CONSTRAINT FK_PES_COMP_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE PERFIL(
                       ...
                       CONSTRAINT FK_PERFIL_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);

INSERT INTO  PERFIL VALUES ( PERFIL_SEQ.nextval,CONTROLE_ALTERACAO_SEQ.currval,'Adiministrador','Perfil de Adiministrador do sistema');
INSERT INTO  PERFIL VALUES ( PERFIL_SEQ.nextval,CONTROLE_ALTERACAO_SEQ.currval,'Aluno','Perfil de aluno');
INSERT INTO  PERFIL VALUES ( PERFIL_SEQ.nextval,CONTROLE_ALTERACAO_SEQ.currval,'Ledor','Perfil de ledor');
INSERT INTO  PERFIL VALUES ( PERFIL_SEQ.nextval,CONTROLE_ALTERACAO_SEQ.currval,'Professor','Perfil de professor');
...
CREATE TABLE USUARIO(
                        ...
                        CONSTRAINT FK_USUARIO_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE ACESSO_LOG(
                           ...
                           CONSTRAINT FK_ACESSO_LOG_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE ASSUNTO(
                        ...
                        CONSTRAINT FK_ASSUNTO_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE AULA(
                     ...
                     CONSTRAINT FK_AULA_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE AULA_LEDOR(
                           ...
                           CONSTRAINT FK_AULA_LEDOR_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE LIVRO(
                      ...
                      CONSTRAINT FK_LIVRO_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID),
...
CREATE TABLE LIVRO_AUTOR(
                            ...
                            CONSTRAINT FK_LIVRO_AUTOR_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE AUDIO_LIVRO(
                            ...
                            CONSTRAINT FK_AUDIO_LIV_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE AUDIO_LIVRO_LEDOR(
                                  ...
                                  CONSTRAINT FK_AUD_LIV_LEDOR_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);
...
CREATE TABLE NOTICIA(
                        ...
                        CONSTRAINT FK_NOTICIA_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID),
                        CONSTRAINT FK_NOTICIA_IMAGEM FOREIGN KEY(ID_IMAGEM) REFERENCES IMAGEM(ID)
);

CREATE TABLE COMENTARIO(
                           ID BIGINT NOT NULL DEFAULT COMENTARIO_SEQ.NEXTVAL,
                           ID_CONTROLE_ALTERACAO BIGINT NOT NULL,
                           TITULO VARCHAR(50) NOT NULL,
                           CORPO VARCHAR(255) NOT NULL,
                           CONSTRAINT PK_COMENTARIO PRIMARY KEY(ID),
                           CONSTRAINT FK_COMENTARIO_CONT_ALT FOREIGN KEY(ID_CONTROLE_ALTERACAO) REFERENCES CONTROLE_ALTERACAO(ID)
);

--COMMENT ON COLUMN USUARIO.TIPO IS 'A-ADMINISTRADOR / C-CLIENTE';
